...
plt.plot(ell, totalcls[:,0], color='pink', linestyle='--', label='total TT, T1 cross T2 from sims')
plt.plot(ell, totalcls_mvTT[:,0], color='lightgreen', linestyle='--', label='total TT, T1 auto from sims')
plt.plot(ell, totalcls_tsznulledTT[:,0], color='powderblue', linestyle='--', label='total TT, T2 auto from sims')
