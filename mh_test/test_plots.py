...
plt.plot(ell, totalcls[:,1], color='lightgreen', linestyle='--', label='total EE')
plt.plot(ell, totalcls[:,2], color='powderblue', linestyle='--', label='total BB')
plt.plot(ell, totalcls[:,3], color='palegoldenrod', linestyle='--', label='total TE')
plt.xscale('log')
plt.yscale('log')
plt.xlim(10,lmax)
#plt.ylim(1e4,1e10)
...
plt.plot(ell, totalcls[:,4], color='lightgreen', linestyle='--', label='total TT, T1 auto from sims')
plt.plot(ell, totalcls[:,5], color='powderblue', linestyle='--', label='total TT, T2 auto from sims')
plt.plot(ell, totalcls[:,1], color='palegoldenrod', linestyle='--', label='total EE from sims')
plt.plot(ell, totalcls[:,2], color='thistle', linestyle='--', label='total BB from sims')
plt.xscale('log')
plt.yscale('log')
plt.xlim(1000,lmax)
plt.ylim(1e-6,1e-2)
...
plt.ylabel("$C_\ell$")
plt.xlabel('$\ell$')
plt.savefig(dir_out+f'/figs/fg_auto_spectra_mh_sim{sim1}.png',bbox_inches='tight')
...
plt.ylabel("$C_\ell$")
plt.xlabel('$\ell$')
plt.savefig(dir_out+f'/figs/fg_cross_spectra_mh_sim{sim1}.png',bbox_inches='tight')

for sim2 in np.arange(41,100):
    ...
    plt.ylabel("$C_\ell$")
    plt.xlabel('$\ell$')
    plt.savefig(dir_out+f'/figs/fg_auto_spectra_mh_sim{sim2}.png',bbox_inches='tight')
    ...
    plt.ylabel("$C_\ell$")
    plt.xlabel('$\ell$')
    plt.savefig(dir_out+f'/figs/fg_cross_spectra_mh_sim{sim2}.png',bbox_inches='tight')
