...
def compare_n0(config_file='test_yuka.yaml', cinv=True):
    ...
    if cinv:
        ...
        n0_standard_eq45to49_total = n0_standard_eq45to49['total'] * (l*(l+1))**2/4
        n0_standard_eq45to49_TTEETE = n0_standard_eq45to49['TTEETE'] * (l*(l+1))**2/4
        n0_standard_eq45to49_TBEB = n0_standard_eq45to49['TBEB'] * (l*(l+1))**2/4
        # lmaxT = 3500
        # lmaxT = 4000
        ...
        n0_mh_withT3_T3E = n0_mh['TE'] * (l*(l+1))**2/4
        n0_mh_withT3_ET3 = n0_mh['ET'] * (l*(l+1))**2/4
        n0_mh_total = n0_mh['total'] * (l*(l+1))**2/4
        n0_mh_TTEETE = n0_mh['TTEETE'] * (l*(l+1))**2/4
        n0_mh_TBEB = n0_mh['TBEB'] * (l*(l+1))**2/4
        # Version still using cinv method but with no T3, 9 estimators
        filename = dir_out+f'/n0/n0_98simpairs_healqest_gmv_cinv_noT3_lmaxT3000_lmaxP4096_nside2048_mh_resp_from_sims_9ests.pkl'
        n0_mh_noT3 = pickle.load(open(filename,'rb'))
        n0_mh_noT3_T1E = n0_mh_noT3['TE'] * (l*(l+1))**2/4
        n0_mh_noT3_ET2 = n0_mh_noT3['ET'] * (l*(l+1))**2/4
        # Version using Eq. 45-49, with T3, 9 estimators, fixed weights as of Aug 2024!
        filename = dir_out+f'/n0/n0_98simpairs_healqest_gmv_withT3_lmaxT3000_lmaxP4096_nside2048_mh_resp_from_sims_9ests_fixedweights.pkl'
        n0_mh_eq45to49 = pickle.load(open(filename,'rb'))
        n0_mh_eq45to49_total = n0_mh_eq45to49['total'] * (l*(l+1))**2/4
        n0_mh_eq45to49_TTEETE = n0_mh_eq45to49['TTEETE'] * (l*(l+1))**2/4
        n0_mh_eq45to49_TBEB = n0_mh_eq45to49['TBEB'] * (l*(l+1))**2/4
        # SQE
        ...
        # Version using Eq. 45-49
        filename = dir_out+f'/n0/n0_98simpairs_healqest_gmv_withT3_lmaxT3000_lmaxP4096_nside2048_crossilc_twoseds_resp_from_sims_9ests_fixedweights.pkl'
        n0_crossilc_twoseds_eq45to49 = pickle.load(open(filename,'rb'))
        n0_crossilc_twoseds_eq45to49_total = n0_crossilc_twoseds_eq45to49['total'] * (l*(l+1))**2/4
        n0_crossilc_twoseds_eq45to49_TTEETE = n0_crossilc_twoseds_eq45to49['TTEETE'] * (l*(l+1))**2/4
        n0_crossilc_twoseds_eq45to49_TBEB = n0_crossilc_twoseds_eq45to49['TBEB'] * (l*(l+1))**2/4
        # SQE
        ...
        n0_crossilc_twoseds_sqe_total = n0_crossilc_twoseds_sqe['total'] * (l*(l+1))**2/4
        # lmaxT = 3500
        # SQE
        ...
        ratio_n0_crossilc_sqe_total = n0_crossilc_twoseds_sqe_total/n0_standard_total
        ...
        plt.plot(l, ratio_n0_crossilc_sqe_total, color='plum', alpha=0.8, linestyle='-',label='Ratio Cross-ILC SQE / Standard GMV')
        plt.xlabel('$\ell$')
        plt.title(f'GMV Reconstruction Noise Comparison')
        plt.legend(loc='upper left', fontsize='small')
        plt.xscale('log')
        ...
        plt.clf()
        ratio_n0_crossilc_twoseds_total = n0_crossilc_twoseds_eq45to49_total/n0_standard_eq45to49_total
        ratio_n0_mh_total = n0_mh_eq45to49_total/n0_standard_eq45to49_total
        ratio_n0_sqe_total = n0_sqe_total/n0_standard_eq45to49_total
        # Ratios with error bars
        plt.axhline(y=1, color='k', linestyle='--')
        plt.plot(l, ratio_n0_mh_total, color='forestgreen', alpha=0.8, linestyle='-',label='Ratio MH GMV / Standard GMV')
        #plt.plot(l, ratio_n0_crossilc_onesed_total,color='goldenrod', alpha=0.8, linestyle='-',label='Ratio Cross-ILC GMV (one component CIB) / Standard GMV')
        ...
        plt.plot(l, ratio_n0_sqe_total, color='firebrick', alpha=0.8, linestyle='-',label='Ratio Standard SQE / Standard GMV')
        plt.xlabel('$\ell$')
        plt.title(f'GMV Reconstruction Noise Comparison, Eq. 45-49')
        plt.legend(loc='upper left', fontsize='small')
        plt.xscale('log')
        plt.ylim(0.9,1.4)
        plt.xlim(10,lmax)
        plt.savefig(dir_out+f'/figs/n0_comparison_gmv_ratio_eq45to49.png',bbox_inches='tight')

        plt.clf()
        ratio_TE = n0_mh_withT3_T3E/n0_mh_noT3_T1E
        ratio_ET = n0_mh_withT3_ET3/n0_mh_noT3_ET2
        ratio_TEplusET = (n0_mh_withT3_T3E+n0_mh_withT3_ET3)/(n0_mh_noT3_T1E+n0_mh_noT3_ET2)
        plt.axhline(y=1, color='k', linestyle='--')
        plt.plot(l, ratio_TE, color='firebrick', alpha=0.8, linestyle='-',label='Ratio MH Cinv N0: T3E / T1E')
        plt.plot(l, ratio_ET, color='darkblue', alpha=0.8, linestyle='-',label='Ratio MH Cinv N0: ET3 / ET2')
        plt.plot(l, ratio_TEplusET, color='forestgreen', alpha=0.8, linestyle='-',label='Ratio MH Cinv N0: T3E+ET3 / T1E+ET2')
        plt.xlabel('$\ell$')
        plt.title(f'GMV Reconstruction Noise Comparison')
        plt.legend(loc='upper left', fontsize='small')
        plt.xscale('log')
        plt.ylim(0.9,1.4)
        plt.xlim(10,lmax)
        plt.savefig(dir_out+f'/figs/n0_comparison_gmv_cinv_ratio_TE_with_vs_without_T3.png',bbox_inches='tight')
