...
def analyze(sims=np.arange(99)+1,n0_n1_sims=np.arange(98)+1,
    ...
    for ii, sim in enumerate(sims):
        ...
        if not withT3:
            ...
            # Load GMV plms
            plm_gmv = np.load(dir_out+f'/plm_all_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
            plm_gmv_TTEETE = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
            plm_gmv_TBEB = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
    ...
    plt.xlabel('$\ell$')
    plt.title(f'Spectra Averaged over {num} Sims, MH, NOT N0/N1 Subtracted')
    ...
    plt.ylim(1e-8,1e-5)
    if not withT3:
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_cinv_12ests_resp_from_sims_raw.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_cinv_12ests_resp_from_sims_raw_withT3.png',bbox_inches='tight')
    ...
    plt.title(f'Ratio of Spectra Averaged over {num} Sims, MH, NOT N0/N1 Subtracted')
    plt.xscale('log')
    #plt.ylim(0.98,1.02)
    plt.xlim(10,lmax)
    if not withT3:
        plt.savefig(dir_out+f'/figs/raw_spec_comparison_ratio_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/raw_spec_comparison_ratio_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_withT3.png',bbox_inches='tight')
    ...
    plt.ylim(1e-9,1e-6)
    if not withT3:
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_cinv_12ests_resp_from_sims_n0n1subtracted_lmaxT{lmaxT}_alt_n0.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_cinv_12ests_resp_from_sims_n0n1subtracted_lmaxT{lmaxT}_alt_n0_withT3.png',bbox_inches='tight')
    ...
    plt.xlim(10,lmax)
    if not withT3:
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_cinv_12ests_resp_from_sims_n0n1subtracted_binnedratio_lmaxT{lmaxT}_alt_n0.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_cinv_12ests_resp_from_sims_n0n1subtracted_binnedratio_lmaxT{lmaxT}_alt_n0_withT3.png',bbox_inches='tight')
    ...
    plt.ylim(1e-8,1e-6)
    if not withT3:
        plt.savefig(dir_out+f'/figs/n0_comparison_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/n0_comparison_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0_withT3.png',bbox_inches='tight')
    ...
    plt.xlim(10,lmax)
    if not withT3:
        plt.savefig(dir_out+f'/figs/n0_comparison_ratio_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/n0_comparison_ratio_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0_withT3.png',bbox_inches='tight')
    ...
    plt.ylabel("$C_\ell^{\kappa\kappa}$")
    plt.xlabel('$\ell$')
    plt.title(f'cinv-style N1 comparison, MH')
    plt.legend(loc='upper left', fontsize='x-small', bbox_to_anchor=(1,0.5))
    plt.xscale('log')
    plt.yscale('log')
    plt.xlim(10,lmax)
    #plt.ylim(1e-8,1e-6)
    if not withT3:
        plt.savefig(dir_out+f'/figs/n1_comparison_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/n1_comparison_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0_withT3.png',bbox_inches='tight')
    ...
    plt.xlim(10,lmax)
    if not withT3:
        plt.savefig(dir_out+f'/figs/n1_comparison_ratio_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0.png',bbox_inches='tight')
    else:
        plt.savefig(dir_out+f'/figs/n1_comparison_ratio_gmv_{num}_sims_mh_cinv_12ests_resp_from_sims_alt_n0_withT3.png',bbox_inches='tight')
    ...
    if os.path.isfile(filename):
        ...
        for i, sim1 in enumerate(sims):
            ...
            if not withT3:
                ...
                plm_gmv_TTEETE_ij = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_noT3_12ests.npy')
                plm_gmv_TBEB_ij = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_noT3_12ests.npy')
                ...
                plm_gmv_TTEETE_ji = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_noT3_12ests.npy')
                plm_gmv_TBEB_ji = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_noT3_12ests.npy')
            else:
                # Get the lensed ij sims
                plm_gmv_ij = np.load(dir_out+f'/plm_all_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
                plm_gmv_TTEETE_ij = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
                plm_gmv_TBEB_ij = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')

                # Now get the ji sims
                plm_gmv_ji = np.load(dir_out+f'/plm_all_healqest_gmv_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
                plm_gmv_TTEETE_ji = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
                plm_gmv_TBEB_ji = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
...
def get_n1(sims,qetype,config,append,withT3=True):
    ...
    if not withT3:
        if qetype == 'gmv':
            ...
            filename = dir_out+f'/n1/n1_{num}simpairs_healqest_{qetype}_noT3_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_resp_from_sims_n0_with_12ests.pkl'
    else:
        if qetype == 'gmv':
            ...
            filename = dir_out+f'/n1/n1_{num}simpairs_healqest_{qetype}_withT3_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_resp_from_sims_n0_with_12ests.pkl'
    ...
    if os.path.isfile(filename):
        ...
        for i, sim in enumerate(sims):
            ...
            if not withT3:
                ...
                plm_gmv_TTEETE_ij = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_noT3_12ests.npy')
                plm_gmv_TBEB_ij = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_noT3_12ests.npy')
                ...
                plm_gmv_TTEETE_ji = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_noT3_12ests.npy')
                plm_gmv_TBEB_ji = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_noT3_12ests.npy')
            else:
                # Get the lensed ij sims
                plm_gmv_ij = np.load(dir_out+f'/plm_all_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_12ests.npy')
                plm_gmv_TTEETE_ij = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_12ests.npy')
                plm_gmv_TBEB_ij = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_12ests.npy')

                # Now get the ji sims
                plm_gmv_ji = np.load(dir_out+f'/plm_all_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_12ests.npy')
                plm_gmv_TTEETE_ji = np.load(dir_out+f'/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_12ests.npy')
                plm_gmv_TBEB_ji = np.load(dir_out+f'/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_12ests.npy')
    ...
    if os.path.isfile(filename):
        ...
        for ii, sim in enumerate(sims):
            ...
            if not withT3:
                ...
                if not cinv:
                    plm = np.load(dir_out+f'/plm_{est}_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_12ests.npy')
                else:
