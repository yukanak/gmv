...
def get_n1(sims,qetype,config,append,withT3=True):
    ...
    if os.path.isfile(filename):
        ...
        n1 = {'total':0, 'T1T2':0, 'T2T1':0, 'EE':0, 'E2E1':0, 'TE':0, 'T2E1':0, 'ET':0, 'E2T1':0, 'TB':0, 'BT':0, 'EB':0, 'BE':0}
        for i, sim in enumerate(sims):
            if not withT3:
                # Get the lensed ij sims
                ...
                plm_E2E1_ij = np.load(dir_out+f'/plm_E2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_cinv_noT3.npy')
                ...
                plm_T2E1_ij = np.load(dir_out+f'/plm_T2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_cinv_noT3.npy')
                ...
                plm_E2T1_ij = np.load(dir_out+f'/plm_E2T1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_cinv_noT3.npy')
                ...
                plm_E2E1_ji = np.load(dir_out+f'/plm_E2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_cinv_noT3.npy')
                ...
                plm_T2E1_ji = np.load(dir_out+f'/plm_T2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_cinv_noT3.npy')
                ...
                plm_E2T1_ji = np.load(dir_out+f'/plm_E2T1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_cinv_noT3.npy')
                ...
                plm_E2E1_ij = np.load(dir_out+f'/plm_E2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_cinv.npy')
                ...
                plm_T2E1_ij = np.load(dir_out+f'/plm_T2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_cinv.npy')
                ...
                plm_E2T1_ij = np.load(dir_out+f'/plm_E2T1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu1tqu2_cinv.npy')
                ...
                plm_E2E1_ji = np.load(dir_out+f'/plm_E2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_cinv.npy')
                ...
                plm_T2E1_ji = np.load(dir_out+f'/plm_T2E1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_cinv.npy')
                ...
                plm_E2T1_ji = np.load(dir_out+f'/plm_E2T1_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cmbonly_phi1_tqu2tqu1_cinv.npy')
            ...
            plm_total_ij = 0.5*plm_T1T2_ij + 0.5*plm_T2T1_ij + 0.5*plm_EE_ij + 0.5*plm_E2E1_ij + 0.5*plm_TE_ij + 0.5*plm_T2E1_ij + 0.5*plm_ET_ij + 0.5*plm_E2T1_ij + plm_TB_ij + plm_BT_ij + plm_EB_ij + plm_BE_ij
            plm_total_ji = 0.5*plm_T1T2_ji + 0.5*plm_T2T1_ji + 0.5*plm_EE_ji + 0.5*plm_E2E1_ji + 0.5*plm_TE_ji + 0.5*plm_T2E1_ji + 0.5*plm_ET_ji + 0.5*plm_E2T1_ji + plm_TB_ji + plm_BT_ji + plm_EB_ji + plm_BE_ji
            ...
            plm_E2E1_ij = hp.almxfl(plm_E2E1_ij,inv_resps[:,3])
            plm_TE_ij = hp.almxfl(plm_TE_ij,inv_resps[:,4])
            plm_T2E1_ij = hp.almxfl(plm_T2E1_ij,inv_resps[:,5])
            plm_ET_ij = hp.almxfl(plm_ET_ij,inv_resps[:,6])
            plm_E2T1_ij = hp.almxfl(plm_E2T1_ij,inv_resps[:,7])
            plm_TB_ij = hp.almxfl(plm_TB_ij,inv_resps[:,8])
            plm_BT_ij = hp.almxfl(plm_BT_ij,inv_resps[:,9])
            plm_EB_ij = hp.almxfl(plm_EB_ij,inv_resps[:,10])
            plm_BE_ij = hp.almxfl(plm_BE_ij,inv_resps[:,11])
            ...
            plm_E2E1_ji = hp.almxfl(plm_E2E1_ji,inv_resps[:,3])
            plm_TE_ji = hp.almxfl(plm_TE_ji,inv_resps[:,4])
            plm_T2E1_ji = hp.almxfl(plm_T2E1_ji,inv_resps[:,5])
            plm_ET_ji = hp.almxfl(plm_ET_ji,inv_resps[:,6])
            plm_E2T1_ji = hp.almxfl(plm_E2T1_ji,inv_resps[:,7])
            plm_TB_ji = hp.almxfl(plm_TB_ji,inv_resps[:,8])
            plm_BT_ji = hp.almxfl(plm_BT_ji,inv_resps[:,9])
            plm_EB_ji = hp.almxfl(plm_EB_ji,inv_resps[:,10])
            plm_BE_ji = hp.almxfl(plm_BE_ji,inv_resps[:,11])
            ...
            auto_E2E1 = hp.alm2cl(plm_E2E1_ij, plm_E2E1_ij, lmax=lmax)
            auto_TE = hp.alm2cl(plm_TE_ij, plm_TE_ij, lmax=lmax)
            auto_T2E1 = hp.alm2cl(plm_T2E1_ij, plm_T2E1_ij, lmax=lmax)
            auto_ET = hp.alm2cl(plm_ET_ij, plm_ET_ij, lmax=lmax)
            auto_E2T1 = hp.alm2cl(plm_E2T1_ij, plm_E2T1_ij, lmax=lmax)
            ...
            cross_E2E1 = hp.alm2cl(plm_E2E1_ij, plm_E2E1_ji, lmax=lmax)
            cross_TE = hp.alm2cl(plm_TE_ij, plm_TE_ji, lmax=lmax)
            cross_T2E1 = hp.alm2cl(plm_T2E1_ij, plm_T2E1_ji, lmax=lmax)
            cross_ET = hp.alm2cl(plm_ET_ij, plm_ET_ji, lmax=lmax)
            cross_E2T1 = hp.alm2cl(plm_E2T1_ij, plm_E2T1_ji, lmax=lmax)
