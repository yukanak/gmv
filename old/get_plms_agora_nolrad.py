...
def main():
    ...
    #filename_sqe = dir_out+f'/plm_{qe}_healqest_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_nolrad.npy'
    #filename_gmv = dir_out+f'/plm_{qe}_healqest_gmv_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_nolrad.npy'
    filename_sqe = dir_out+f'/plm_{qe}_healqest_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_nolradlksz.npy'
    filename_gmv = dir_out+f'/plm_{qe}_healqest_gmv_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_nolradlksz.npy'
...
def do_reconstruction(qe,append,config_file):
    ...
    # Agora sims
    #agora_095 = '/oak/stanford/orgs/kipac/users/yukanaka/agora_sims_20240904/agora_spt3g_95ghz_alm_lmax4096_nolrad.fits'
    #agora_150 = '/oak/stanford/orgs/kipac/users/yukanaka/agora_sims_20240904/agora_spt3g_150ghz_alm_lmax4096_nolrad.fits'
    #agora_220 = '/oak/stanford/orgs/kipac/users/yukanaka/agora_sims_20240904/agora_spt3g_220ghz_alm_lmax4096_nolrad.fits'
    agora_095 = '/oak/stanford/orgs/kipac/users/yukanaka/agora_sims_20240904/agora_spt3g_95ghz_alm_lmax4096_nolradlksz.fits'
    agora_150 = '/oak/stanford/orgs/kipac/users/yukanaka/agora_sims_20240904/agora_spt3g_150ghz_alm_lmax4096_nolradlksz.fits'
    agora_220 = '/oak/stanford/orgs/kipac/users/yukanaka/agora_sims_20240904/agora_spt3g_220ghz_alm_lmax4096_nolradlksz.fits'
    ...
    if append == 'agora_standard' or append == 'agora_profhrd':
        ...
        cltt_tot = totalcls[:,0]; clee_tot = totalcls[:,1]; clbb_tot = totalcls[:,2]; clte_tot = totalcls[:,3]
        # Difference
        cltt_diff = cltt_tot - cltt; clee_diff = clee_tot - clee; clbb_diff = clbb_tot - clbb; clte_diff = clte_tot - clte
        # Get Gaussian realization
        tlm_diff,elm_diff,blm_diff = hp.synalm([cltt_diff,clee_diff,clbb_diff,clte_diff],new=True,lmax=lmax)
        tlm_mv += tlm_diff; elm += elm_diff; blm += blm_diff
    else:
    ...
    artificial_noise = np.zeros(lmax+1)
    artificial_noise[lmaxT+2:] = 1.e10
    #totalcls_filename = dir_out+f'totalcls/totalcls_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_nolrad.npy'
    totalcls_filename = dir_out+f'totalcls/totalcls_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_nolradlksz.npy'
