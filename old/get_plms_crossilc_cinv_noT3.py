...
def main():
    ...
    filename_gmv = dir_out+f'/plm_{qe}_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cinv_noT3.npy'
...
def do_reconstruction(qe,sim1,sim2,append,config_file):
    ...
    if append == 'crossilc_onesed' or append == 'crossilc_onesed_unl' or append == 'crossilc_twoseds' or append == 'crossilc_twoseds_unl':
        ...
        if qe == 'T1T2':
            ...
            almbar1 = hp.almxfl((hp.almxfl(tlm1_tszn,clee)-hp.almxfl(elm1,clte)),invDl2)
            almbar2 = hp.almxfl((hp.almxfl(elm2,cltt1)-hp.almxfl(tlm2_cibn,clte)),invDl1)
        elif qe == 'E2T1':
            almbar1 = hp.almxfl((hp.almxfl(elm1,cltt2)-hp.almxfl(tlm1_tszn,clte)),invDl2)
            almbar2 = hp.almxfl((hp.almxfl(tlm2_cibn,clee)-hp.almxfl(elm2,clte)),invDl1)
        elif qe == 'E2E1':
            almbar1 = hp.almxfl((hp.almxfl(elm1,cltt2)-hp.almxfl(tlm1_tszn,clte)),invDl2)
            almbar2 = hp.almxfl((hp.almxfl(elm2,cltt1)-hp.almxfl(tlm2_cibn,clte)),invDl1)
        else:
            if qe[0] == 'T': almbar1 = hp.almxfl((hp.almxfl(tlm1_cibn,clee)-hp.almxfl(elm1,clte)),invDl1)
            elif qe[0] == 'E': almbar1 = hp.almxfl((hp.almxfl(elm1,cltt1)-hp.almxfl(tlm1_cibn,clte)),invDl1)
            elif qe[0] == 'B': almbar1 = hp.almxfl(blm1,flb)

            if qe[1] == 'T': almbar2 = hp.almxfl((hp.almxfl(tlm2_tszn,clee)-hp.almxfl(elm2,clte)),invDl2)
        ...
        if qe == 'T1T2':
            ...
            almbar1 = hp.almxfl((hp.almxfl(tlm1,clee)-hp.almxfl(elm1,clte)),invDl2)
            almbar2 = hp.almxfl((hp.almxfl(elm2,cltt1)-hp.almxfl(tlm2,clte)),invDl1)
        elif qe == 'E2T1':
            almbar1 = hp.almxfl((hp.almxfl(elm1,cltt2)-hp.almxfl(tlm1,clte)),invDl2)
            almbar2 = hp.almxfl((hp.almxfl(tlm2,clee)-hp.almxfl(elm2,clte)),invDl1)
        elif qe == 'E2E1':
            almbar1 = hp.almxfl((hp.almxfl(elm1,cltt2)-hp.almxfl(tlm1,clte)),invDl2)
            almbar2 = hp.almxfl((hp.almxfl(elm2,cltt1)-hp.almxfl(tlm2,clte)),invDl1)
