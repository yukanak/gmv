...
def main():
    ...
    filename_gmv = dir_out+f'/plm_{qe}_healqest_gmv_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cinv.npy'
...
def do_reconstruction(qe,append,config_file):
    ...
    if qe == 'E2T1': qe='ET'
    if qe == 'E2E1': qe='EE'
    glm,clm = q.eval(qe,almbar1,almbar2,u=u)
    # Save plm and clm
