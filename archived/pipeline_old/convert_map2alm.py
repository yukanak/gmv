...
tlm,elm,blm = hp.map2alm([t,q,u],lmax=6000)
hp.fitsfunc.write_alm(f'/oak/stanford/orgs/kipac/users/yukanaka/agora_sims/agora_lcib_spt3g_150ghz_alm_lmax6000.fits',[tlm,elm,blm])
...
tlm,elm,blm = hp.map2alm([t,q,u],lmax=6000)
hp.fitsfunc.write_alm(f'/oak/stanford/orgs/kipac/users/yukanaka/agora_sims/agora_ltsz_spt3g_150ghz_alm_lmax6000.fits',[tlm,elm,blm])
