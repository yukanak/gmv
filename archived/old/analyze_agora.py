...
def analyze():
    ...
    #binned_bias_gmv_3000 = get_lensing_bias(config,append_list,cinv=False,sqe=False,sims=np.arange(249)+1,n0_n1_sims=np.arange(248)+1)
    #binned_bias_sqe_3000 = get_lensing_bias(config,append_list,cinv=False,sqe=True,sims=np.arange(249)+1,n0_n1_sims=np.arange(248)+1)
    ...
    binned_bias_gmv_3000_cinv = get_lensing_bias(config,append_list,cinv=True,sqe=False,sims=np.arange(249)+1,n0_n1_sims=np.arange(248)+1)

    # lmaxT = 3500 cases, cinv
    config_file='test_yuka_lmaxT3500.yaml'
    config = utils.parse_yaml(config_file)
    append_list = ['agora_standard', 'agora_mh', 'agora_crossilc_twoseds', 'agora_crossilc_onesed']
    #binned_bias_gmv_3500_cinv = get_lensing_bias(config,append_list,cinv=True,sqe=False,sims=np.arange(249)+1,n0_n1_sims=np.arange(248)+1)

    # lmaxT = 4000 cases, cinv
    config_file='test_yuka_lmaxT4000.yaml'
    config = utils.parse_yaml(config_file)
    append_list = ['agora_standard', 'agora_mh', 'agora_crossilc_twoseds', 'agora_crossilc_onesed']
    #binned_bias_gmv_4000_cinv = get_lensing_bias(config,append_list,cinv=True,sqe=False,sims=np.arange(249)+1,n0_n1_sims=np.arange(248)+1)

    # lmaxT = 3000, rdn0 and cinv
    config_file='test_yuka.yaml'
    config = utils.parse_yaml(config_file)
    append_list = ['agora_standard']
    #binned_bias_gmv_3000_cinv_rdn0 = get_lensing_bias(config,append_list,cinv=True,rdn0=True, sqe=False,sims=np.arange(249)+1,n0_n1_sims=np.arange(248)+1)
...
def get_lensing_bias(config, append_list, cinv=False, rdn0=False, sqe=False, sims=np.arange(249)+1, n0_n1_sims=np.arange(248)+1):
    '''
