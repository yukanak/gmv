...
def main():
    ...
    #filename_gmv = dir_out+f'/plm_{qe}_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cinv_noT3_nulledclte.npy'
    filename_gmv = dir_out+f'/plm_{qe}_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_cinv_noT3_cutweights_lightblue.npy'
...
def do_reconstruction(qe,sim1,sim2,append,config_file):
    ...
    #clte = np.zeros_like(clte)

    if append == 'mh' or append == 'mh_unl':
        #if qe[:2] == 'T1': almbar1 = hp.almxfl((hp.almxfl(tlm1_mv,clee)),invDl1)
        #elif qe[:2] == 'T2': almbar1 = hp.almxfl((hp.almxfl(tlm1_tszn,clee)),invDl2)

        #if qe[2:4] == 'T1': almbar2 = hp.almxfl((-1*hp.almxfl(elm2,clte)),invDl1)
        #elif qe[2:4] == 'T2': almbar2 = hp.almxfl((-1*hp.almxfl(elm2,clte)),invDl2)

        if qe[:2] == 'T1': almbar1 = hp.almxfl((-1*hp.almxfl(elm1,clte)),invDl1)
        elif qe[:2] == 'T2': almbar1 = hp.almxfl((-1*hp.almxfl(elm1,clte)),invDl2)

        if qe[2:4] == 'T1': almbar2 = hp.almxfl((hp.almxfl(tlm2_mv,clee)),invDl1)
        elif qe[2:4] == 'T2': almbar2 = hp.almxfl((hp.almxfl(tlm2_tszn,clee)),invDl2)
        ...
        #elif qe[:2] == 'E2': almbar1 = hp.almxfl((hp.almxfl(elm1,cltt2)-hp.almxfl(tlm1_tszn,clte)),invDl2)
        #elif qe[0] == 'T': almbar1 = hp.almxfl((hp.almxfl(tlm1_mv,clee)-hp.almxfl(elm1,clte)),invDl1)
        #elif qe[0] == 'E': almbar1 = hp.almxfl((hp.almxfl(elm1,cltt1)-hp.almxfl(tlm1_mv,clte)),invDl1)
        ...
        #elif qe[2:4] == 'E1': almbar2 = hp.almxfl((hp.almxfl(elm2,cltt1)-hp.almxfl(tlm2_mv,clte)),invDl1)
        #elif qe[1] == 'T': almbar2 = hp.almxfl((hp.almxfl(tlm2_tszn,clee)-hp.almxfl(elm2,clte)),invDl2)
        #elif qe[1] == 'E': almbar2 = hp.almxfl((hp.almxfl(elm2,cltt2)-hp.almxfl(tlm2_tszn,clte)),invDl2)
        ...
        elif qe[:2] == 'E2': almbar1 = hp.almxfl((hp.almxfl(elm1,cltt2)-hp.almxfl(tlm1,clte)),invDl2)
        elif qe[0] == 'T': almbar1 = hp.almxfl((hp.almxfl(tlm1,clee)-hp.almxfl(elm1,clte)),invDl1)
        ...
        elif qe[2:4] == 'E1': almbar2 = hp.almxfl((hp.almxfl(elm2,cltt1)-hp.almxfl(tlm2,clte)),invDl1)
        elif qe[1] == 'T': almbar2 = hp.almxfl((hp.almxfl(tlm2,clee)-hp.almxfl(elm2,clte)),invDl2)
