...
def analyze(sims=np.arange(100)+1,n0_n1_sims=np.arange(99)+1,
    ...
    if u is not None:
        ...
        if resp_from_sims:
            resp_gmv_hrd = np.load(f'/oak/stanford/orgs/kipac/users/yukanaka/outputs/resp/sim_resp_gmv_estall_hrd_{num}sims_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_tsrc_fluxlim{fluxlim:.3f}.npy')
            resp_gmv_TTEETE_hrd = np.load(f'/oak/stanford/orgs/kipac/users/yukanaka/outputs/resp/sim_resp_gmv_estTTEETE_hrd_{num}sims_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_tsrc_fluxlim{fluxlim:.3f}.npy')
        else:
    ...
    for ii, sim in enumerate(sims):
        # Load GMV plms
        plm_gmv = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_all_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
        plm_gmv_TTEETE = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
        plm_gmv_TBEB = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
        ...
        if u is not None:
            # Harden!
            # GMV
            glm_prf_TTEETE = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTEETEprf_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
    ...
    if save_fig:
        ...
        #plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_n0n1subtracted_202402.png',bbox_inches='tight')
        ...
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_n0n1subtracted_resp_from_sims_202403.png',bbox_inches='tight')
    ...
    if save_fig:
        ...
        plt.savefig(dir_out+f'/figs/{num}_sims_comparison_{append}_n0n1subtracted_binnedratio_resp_from_sims_202403.png',bbox_inches='tight')
...
def get_n0(sims,qetype,config,
    ...
    if u is not None and not noiseless:
        ...
        append = 'cmbonly'
    filename = f'/oak/stanford/orgs/kipac/users/yukanaka/outputs/n0/n0_lensing19-20_with_foregrounds_no_noise/n0_{num}simpairs_healqest_{qetype}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}'
    ...
    '''
        ...
        if harden:
            ...
            weight_gmv = -1 * resp_gmv_TTEETE_sk / resp_gmv_TTEETE_ss
            if resp_from_sims:
                resp_gmv = np.load(dir_out+f'/resp/sim_resp_gmv_estall_hrd_{num+1}sims_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_tsrc_fluxlim{fluxlim:.3f}.npy')
                resp_gmv_TTEETE = np.load(dir_out+f'/resp/sim_resp_gmv_estTTEETE_hrd_{num+1}sims_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_tsrc_fluxlim{fluxlim:.3f}.npy')
            else:
        ...
        for i, sim1 in enumerate(sims):
            ...
            if harden:
                # Harden!
                glm_prf_TTEETE_ij = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TTEETEprf_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
                ...
                glm_prf_TTEETE_ji = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TTEETEprf_healqest_gmv_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
        ...
        if harden:
            ...
            weight_original = -1 * resp_original_TT_sk / resp_original_TT_ss
            if resp_from_sims:
                resp_original = np.load(dir_out+f'/resp/sim_resp_sqe_estall_hrd_{num+1}sims_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_tsrc_fluxlim{fluxlim:.3f}.npy')
                resps_original[:,0] = np.load(dir_out+f'/resp/sim_resp_sqe_estTT_hrd_{num+1}sims_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_tsrc_fluxlim{fluxlim:.3f}.npy')
            else:
        ...
        for i, sim1 in enumerate(sims):
            ...
            # Get the lensed ij sims
            plm_TT_ij = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TT_healqest_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_EE_ij = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_EE_healqest_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_TE_ij = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TE_healqest_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_TB_ij = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TB_healqest_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_EB_ij = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_EB_healqest_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')

            # Now get the ji sims
            plm_TT_ji = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TT_healqest_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_EE_ji = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_EE_healqest_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_TE_ji = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TE_healqest_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_TB_ji = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_TB_healqest_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
            plm_EB_ji = np.load(dir_out+f'/outputs_lensing19-20_no_foregrounds_with_ilc_noise/plm_EB_healqest_seed1_{sim2}_seed2_{sim1}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}.npy')
...
def get_n1(sims,qetype,config,
    ...
    l = np.arange(lmax+1,dtype=np.float_)
    num = len(sims)
    filename = dir_out+f'/n1/n1_lensing19-20_with_foregrounds_no_noise/n1_{num}simpairs_healqest_{qetype}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly'
    if resp_from_sims:
        filename += '_resp_from_sims'
    if not harden:
        filename += '_no_hrd'
    ...
    if os.path.isfile(filename):
        ...
        for i, sim in enumerate(sims):
            ...
            # Get the lensed ij sims
            plm_gmv_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise//plm_all_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
            plm_gmv_TTEETE_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
            plm_gmv_TBEB_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')

            # Now get the ji sims
            plm_gmv_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_all_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
            plm_gmv_TTEETE_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTEETE_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
            plm_gmv_TBEB_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TBEB_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')

            if harden:
                # Harden!
                glm_prf_TTEETE_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTEETEprf_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
                plm_gmv_ij = plm_gmv_ij + hp.almxfl(glm_prf_TTEETE_ij, weight_gmv) # Equivalent to plm_gmv_TTEETE_ij (hardened) + plm_gmv_TBEB_ij (unhardened)
                plm_gmv_TTEETE_ij = plm_gmv_TTEETE_ij + hp.almxfl(glm_prf_TTEETE_ij, weight_gmv)

                glm_prf_TTEETE_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTEETEprf_healqest_gmv_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
                plm_gmv_ji = plm_gmv_ji + hp.almxfl(glm_prf_TTEETE_ji, weight_gmv) # Equivalent to plm_gmv_TTEETE_ji (hardened) + plm_gmv_TBEB_ji (unhardened)
                plm_gmv_TTEETE_ji = plm_gmv_TTEETE_ji + hp.almxfl(glm_prf_TTEETE_ji, weight_gmv)
        ...
        for i, sim in enumerate(sims):
            # Get the lensed ij sims
            plm_TT_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TT_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
            plm_EE_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_EE_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
            plm_TE_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TE_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
            plm_TB_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TB_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
            plm_EB_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_EB_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')

            # Now get the ji sims
            plm_TT_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TT_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
            plm_EE_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_EE_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
            plm_TE_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TE_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
            plm_TB_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TB_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
            plm_EB_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_EB_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')

            if harden:
                # Harden!
                glm_prf_TT_ij = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTprf_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu1tqu2.npy')
                plm_TT_ij = plm_TT_ij + hp.almxfl(glm_prf_TT_ij, weight_original)

                glm_prf_TT_ji = np.load(dir_out+f'/outputs_lensing19-20_with_foregrounds_no_noise/plm_TTprf_healqest_seed1_{sim}_seed2_{sim}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_cmbonly_phi1_tqu2tqu1.npy')
                plm_TT_ji = plm_TT_ji + hp.almxfl(glm_prf_TT_ji, weight_original)
