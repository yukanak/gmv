...
t95_lcmb_new,q95_lcmb_new,u95_lcmb_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_95ghz_lcmbNG_uk.fits',field=[0,1,2])
t95_lcib_lksz_lrad_new,q95_lcib_lksz_lrad_new,u95_lcib_lksz_lrad_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_95ghz_lcibNG_lkszNGbahamas80_lradNG_uk.fits',field=[0,1,2])
t95_ltsz_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_95ghz_ltszNGbahamas80_uk_diffusioninp.fits')

print(np.array_equal(t95_lcmb, t95_lcmb_new))
print(np.array_equal(q95_lcmb, q95_lcmb_new))
print(np.array_equal(u95_lcmb, u95_lcmb_new))
print(np.array_equal(t95_lcib_lksz_lrad, t95_lcib_lksz_lrad_new))
print(np.array_equal(q95_lcib_lksz_lrad, q95_lcib_lksz_lrad_new))
print(np.array_equal(u95_lcib_lksz_lrad, u95_lcib_lksz_lrad_new))
print(np.array_equal(t95_ltsz, t95_ltsz_new))
print("#====================================================================#")
...
t150_lcmb_new,q150_lcmb_new,u150_lcmb_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_150ghz_lcmbNG_uk.fits',field=[0,1,2])
t150_lcib_lksz_lrad_new,q150_lcib_lksz_lrad_new,u150_lcib_lksz_lrad_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_150ghz_lcibNG_lkszNGbahamas80_lradNG_uk.fits',field=[0,1,2])
t150_ltsz_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_150ghz_ltszNGbahamas80_uk_diffusioninp.fits')

print(np.array_equal(t150_lcmb, t150_lcmb_new))
print(np.array_equal(q150_lcmb, q150_lcmb_new))
print(np.array_equal(u150_lcmb, u150_lcmb_new))
print(np.array_equal(t150_lcib_lksz_lrad, t150_lcib_lksz_lrad_new))
print(np.array_equal(q150_lcib_lksz_lrad, q150_lcib_lksz_lrad_new))
print(np.array_equal(u150_lcib_lksz_lrad, u150_lcib_lksz_lrad_new))
print(np.array_equal(t150_ltsz, t150_ltsz_new))
print("#====================================================================#")
...
t220_lcmb_new,q220_lcmb_new,u220_lcmb_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_220ghz_lcmbNG_uk.fits',field=[0,1,2])
t220_lcib_lksz_lrad_new,q220_lcib_lksz_lrad_new,u220_lcib_lksz_lrad_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_220ghz_lcibNG_lkszNGbahamas80_lradNG_uk.fits',field=[0,1,2])
t220_ltsz_new = hp.read_map(f'/scratch/users/yomori/v021125/agora/mdpl2_spt3g_220ghz_ltszNGbahamas80_uk_diffusioninp.fits')

print(np.array_equal(t220_lcmb, t220_lcmb_new))
print(np.array_equal(q220_lcmb, q220_lcmb_new))
print(np.array_equal(u220_lcmb, u220_lcmb_new))
print(np.array_equal(t220_lcib_lksz_lrad, t220_lcib_lksz_lrad_new))
print(np.array_equal(q220_lcib_lksz_lrad, q220_lcib_lksz_lrad_new))
print(np.array_equal(u220_lcib_lksz_lrad, u220_lcib_lksz_lrad_new))
print(np.array_equal(t220_ltsz, t220_ltsz_new))
print("#====================================================================#")
