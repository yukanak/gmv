...
def compare_n0(config_file='test_yuka.yaml', cinv=True):
    ...
    # MH GMV
    # lmaxT = 3500
    filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT3500_lmaxP4096_nside2048_agora_mh_resp_from_sims.pkl'
    n0_mh_3500 = pickle.load(open(filename,'rb'))
    n0_mh_3500_total = n0_mh_3500 * (l*(l+1))**2/4
    # lmaxT = 4000
    filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT4000_lmaxP4096_nside2048_agora_mh_resp_from_sims.pkl'
    n0_mh_4000 = pickle.load(open(filename,'rb'))
    n0_mh_4000_total = n0_mh_4000 * (l*(l+1))**2/4

    # MH GMV, WEBSKY
    # lmaxT = 3500
    filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT3500_lmaxP4096_nside2048_websky_mh_resp_from_sims.pkl'
    n0_mh_3500_websky = pickle.load(open(filename,'rb'))
    n0_mh_3500_websky_total = n0_mh_3500_websky * (l*(l+1))**2/4
    # lmaxT = 4000
    filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT4000_lmaxP4096_nside2048_websky_mh_resp_from_sims.pkl'
    ...
    # lmaxT = 3500
    #filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT3500_lmaxP4096_nside2048_agora_crossilc_onesed_resp_from_sims.pkl'
    #n0_crossilc_onesed_3500 = pickle.load(open(filename,'rb'))
    #n0_crossilc_onesed_3500_total = n0_crossilc_onesed_3500 * (l*(l+1))**2/4
    # lmaxT = 4000
    #filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT4000_lmaxP4096_nside2048_agora_crossilc_onesed_resp_from_sims.pkl'
    ...
    # lmaxT = 3500
    filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT3500_lmaxP4096_nside2048_websky_crossilc_onesed_resp_from_sims.pkl'
    ...
    # lmaxT = 4000
    filename = dir_out+f'/n0/rdn0_249simpairs_healqest_gmv_cinv_noT3_lmaxT4000_lmaxP4096_nside2048_websky_crossilc_onesed_resp_from_sims.pkl'
