...
def main():
    ...
    if append[-4:] != 'cinv' and (qe == 'TT' or qe == 'TE' or  qe == 'ET' or qe == 'EE' or qe == 'TB' or  qe == 'BT' or qe == 'EB' or  qe == 'BE' or qe == 'TTprf' or qe == 'T1T2' or qe == 'T2T1' or qe == 'T2E1' or qe == 'E2T1' or qe == 'E2E1'):
        ...
        # GMV
        gmv = True
        filename = dir_out+f'/plm_{qe}_healqest_gmv_seed1_{sim1}_seed2_{sim2}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{fg_model}_{append}_{T3_opt}_12ests.npy'
...
def do_reconstruction(qe,sim1,sim2,append,config_file,filename,gmv,cinv,T3_opt,fg_model):
    ...
    if fg_model == 'agora':
        if sim1 == 'r':
            ...
            fnlm_cibn_twoseds_sim2 = f'/oak/stanford/orgs/kipac/users/yukanaka/gmv/inputs/spt3g_2019_2020_agora/agora_fg_plus_spt3g_20192020_noise_lmax{lmax}_seed{sim2}_cibn_twoseds.fits'
        elif sim2 == 'r':
            ...
            fnlm_cibn_twoseds_sim1 = f'/oak/stanford/orgs/kipac/users/yukanaka/gmv/inputs/spt3g_2019_2020_agora/agora_fg_plus_spt3g_20192020_noise_lmax{lmax}_seed{sim1}_cibn_twoseds.fits'
        else:
            fnlm_mv_sim1 = f'/oak/stanford/orgs/kipac/users/yukanaka/gmv/inputs/spt3g_2019_2020_agora/agora_fg_plus_spt3g_20192020_noise_lmax{lmax}_seed{sim1}_mv.fits'
            fnlm_tszn_sim1 = f'/oak/stanford/orgs/kipac/users/yukanaka/gmv/inputs/spt3g_2019_2020_agora/agora_fg_plus_spt3g_20192020_noise_lmax{lmax}_seed{sim1}_tszn.fits'
            fnlm_cibn_onesed_sim1 = f'/oak/stanford/orgs/kipac/users/yukanaka/gmv/inputs/spt3g_2019_2020_agora/agora_fg_plus_spt3g_20192020_noise_lmax{lmax}_seed{sim1}_cibn_onesed.fits'
    ...
    if append_shortened == 'mh' or append_shortened == 'crossilc_twoseds' or append_shortened == 'crossilc_onesed':
        if sim1 == 'r':
            ...
            if fg_model == 'agora':
                tfnlm2_cibn_twoseds, efnlm2_cibn_twoseds, bfnlm2_cibn_twoseds = hp.read_alm(fnlm_cibn_twoseds_sim2,hdu=[1,2,3])
            ...
            elif append_shortened == 'crossilc_twoseds':
                tlm2_cibn += tfnlm2_cibn_twoseds
                elm2_cibn += efnlm2_cibn_twoseds
                blm2_cibn += bfnlm2_cibn_twoseds
            sim1 = 999
        elif sim2 == 'r':
            ...
            if fg_model == 'agora':
                tfnlm1_cibn_twoseds, efnlm1_cibn_twoseds, bfnlm1_cibn_twoseds = hp.read_alm(fnlm_cibn_twoseds_sim1,hdu=[1,2,3])
            ...
            if append_shortened == 'crossilc_onesed':
                ...
                tlm1_cibn += tfnlm1_cibn_twoseds
                elm1_cibn += efnlm1_cibn_twoseds
                blm1_cibn += bfnlm1_cibn_twoseds
    ...
    if sim1 == 999:
        ...
        if fg_model == 'agora' and (append_shortened == 'crossilc_twoseds' or append_shortened == 'crossilc_onesed'):
        ...
        elif fg_model == 'websky' and (append_shortened == 'crossilc_twoseds' or append_shortened == 'crossilc_onesed'):
    ...
    if append[:2] == 'mh':
        ...
        totalcls_filename = dir_out+f'totalcls/totalcls_average_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{fg_model}_crossilc_twoseds.npy'
    ...
    if cinv:
        ...
        alm1all = np.zeros((len(tlm1_T3),12), dtype=np.complex_)
        alm2all = np.zeros((len(tlm2_T3),12), dtype=np.complex_)
        # T1T2
        ...
        if T3_opt == 'noT3':
            ...
            # BT
            alm1all[:,9] = hp.almxfl(blm1,flb)
            alm2all[:,9] = hp.almxfl(tlm2,invDl2)
            # EB
            alm1all[:,10] = hp.almxfl(elm1,invDl1)
            alm2all[:,10] = hp.almxfl(blm2,flb)
            # BE
            alm1all[:,11] = hp.almxfl(blm1,flb)
            alm2all[:,11] = hp.almxfl(elm2,invDl2)
        elif T3_opt == 'withT3':
            # EE
            ...
            # BT
            alm1all[:,9] = hp.almxfl(blm1,flb)
            alm2all[:,9] = hp.almxfl(tlm2_T3,invDl3)
            # EB
            alm1all[:,10] = hp.almxfl(elm1,invDl3)
            alm2all[:,10] = hp.almxfl(blm2,flb)
            # BE
            alm1all[:,11] = hp.almxfl(blm1,flb)
            alm2all[:,11] = hp.almxfl(elm2,invDl3)
