...
def main():
    ...
    if append[-4:] != 'cinv' and (qe == 'TT' or qe == 'TE' or  qe == 'ET' or qe == 'EE' or qe == 'TB' or  qe == 'BT' or qe == 'EB' or  qe == 'BE' or qe == 'TTprf' or qe == 'T1T2' or qe == 'T2T1' or qe == 'T2E1' or qe == 'E2T1' or qe == 'E2E1'):
        ...
        gmv = True
        if T3_opt == 'noT3' or T3_opt == 'withT3':
            filename = dir_out+f'/plm_{qe}_healqest_gmv_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{fg_model}_{append}_{T3_opt}_12ests.npy'
        else:
            filename = dir_out+f'/plm_{qe}_healqest_gmv_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{fg_model}_{append}.npy'
...
def do_reconstruction(qe,append,config_file,filename,gmv,cinv,T3_opt,fg_model):
    ...
    #TODO: comment out entire block if lcmb only WebSky sanity check
    ...
    if fg_model == 'agora':
        ...
        if append == 'crossilc_onesed' or append == 'crossilc_twoseds' or append == 'crossilc_onesed_cinv' or append == 'crossilc_twoseds_cinv':
