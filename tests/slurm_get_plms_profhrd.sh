...
ests=(all TTEETE TBEB TTEETEprf)
qe=${ests[$SLURM_ARRAY_TASK_ID%4-1]}
sim1=$(((SLURM_ARRAY_TASK_ID-1)/4+1))
sim2=$(((SLURM_ARRAY_TASK_ID-1)/4+2))

export OMP_NUM_THREADS=12

#~/gmv/tests/get_plms_profhrd.py all $SLURM_ARRAY_TASK_ID $SLURM_ARRAY_TASK_ID profhrd
