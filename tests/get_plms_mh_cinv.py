...
def do_reconstruction(qe,sim1,sim2,append,config_file):
    ...
    if append == 'mh' or append == 'mh_unl':
        ...
        elif qe[0] == 'E': almbar1 = hp.almxfl((hp.almxfl(elm1,cltt)-hp.almxfl(tlm1_mv,clte)),invDl3)
        ...
        elif qe[1] == 'E': almbar2 = hp.almxfl((hp.almxfl(elm2,cltt)-hp.almxfl(tlm2_mv,clte)),invDl3)
        ...
        elif qe[0] == 'E': almbar1 = hp.almxfl((hp.almxfl(elm1,cltt)-hp.almxfl(tlm1,clte)),invDl3)
        elif qe[0] == 'B': almbar1 = hp.almxfl(blm1,flb)
        ...
        elif qe[1] == 'E': almbar2 = hp.almxfl((hp.almxfl(elm2,cltt)-hp.almxfl(tlm2,clte)),invDl3)
        elif qe[1] == 'B': almbar2 = hp.almxfl(blm2,flb)
