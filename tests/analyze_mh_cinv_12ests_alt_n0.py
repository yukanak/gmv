...
def get_n0(sims,qetype,config,append,cmbonly=False,withT3=True):
    ...
    if not withT3:
        ...
        filename = dir_out+f'/n0/n0_{num}simpairs_healqest_{qetype}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_resp_from_sims_12ests.pkl'
...
def get_n1(sims,qetype,config,append,withT3=True):
    ...
    if not withT3:
        ...
        if qetype == 'gmv':
            filename = dir_out+f'/n1/n1_{num}simpairs_healqest_{qetype}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_resp_from_sims_12ests.pkl'
        else:
            filename = dir_out+f'/n1/n1_{num}simpairs_healqest_{qetype}_lmaxT{lmaxT}_lmaxP{lmaxP}_nside{nside}_{append}_resp_from_sims_n0_with_12ests.pkl'
